...
export default function Home() {
  ...
  return (
    <main className="bg-gradient-to-b from-[#F5F5F7] via-[#FAFAFA] to-white text-[#1D1D1F] antialiased tracking-tight scroll-smooth">
      ...
      <section className="min-h-screen flex items-center justify-center px-10 pt-40">
        ...
        <div className="max-w-6xl w-full grid grid-cols-1 md:grid-cols-2 gap-20 items-center">
          ...
          {/* IMAGE (ENLARGED + FULL PRESENCE) */}
          <div className="flex justify-center md:justify-end">
            <div className="relative w-full md:w-[520px] h-[620px] rounded-[40px] overflow-hidden bg-[#F3F4F6] shadow-2xl border border-white/50">

              <img
                src="/profile.jpg"
                className="w-full h-full object-contain pt-10 scale-105 hover:scale-110 transition duration-700"
              />
    ...
    <section id="education" className="py-40 px-6 max-w-5xl mx-auto">
        {/* 标题字号对齐 Work 的 text-2xl */}
        <h2 className="text-2xl font-semibold mb-12">
          {lang === "zh" ? "教育与实践经历" : "Education & Practice"}
        </h2>
        
        <div className="relative border-l border-gray-200 ml-2 md:ml-3 space-y-16">
          
          {/* Item 1: University of Malaya */}
          <div className="relative pl-8 md:pl-10 group cursor-default">
            {/* 时间轴圆点 */}
            <div className="absolute w-2.5 h-2.5 bg-gray-200 rounded-full -left-[5.5px] top-2 ring-4 ring-[#FAFAFA] transition-all duration-300 group-hover:bg-gray-800"></div>
            
            {/* 院校名称对齐 Work 的 text-lg */}
            ...
            <div className="flex items-center gap-3 mt-1.5">
              <span className="text-sm text-gray-500">2025.09 — 2026.09</span>
              <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-[11px] font-medium bg-gray-100 text-gray-600 tracking-wide">
                {lang === "zh" ? "科学传播硕士" : "MSc Science Communication"}
              </span>
            </div>
            
            {/* 正文内容对齐 Work 的 text-sm leading-6 tracking-wide */}
            <ul className="space-y-5 text-sm text-gray-600/85 leading-6 tracking-wide mt-6">
              {lang === "zh" ? (
                <>
          ...
          <div className="relative pl-8 md:pl-10 group cursor-default">
            ...
            <div className="flex items-center gap-3 mt-1.5">
              <span className="text-sm text-gray-500">2022.01 — 2025.06</span>
              <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-[11px] font-medium bg-gray-100 text-gray-600 tracking-wide">
          ...
          <div className="relative pl-8 md:pl-10 group cursor-default">
            ...
            <div className="flex items-center gap-3 mt-1.5">
              <span className="text-sm text-gray-500">2018.09 — 2022.06</span>
              <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-[11px] font-medium bg-gray-100 text-gray-600 tracking-wide">
      ...
      <section id="beyond" className="py-32 px-6 max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          {/* 摄影卡片 */}
          <div onClick={() => setActiveBeyond("photo")} className="group p-8 rounded-3xl bg-white border border-gray-100 shadow-[0_2px_10px_rgba(0,0,0,0.02)] hover:shadow-[0_8px_30px_rgba(0,0,0,0.06)] hover:-translate-y-1 transition-all duration-500 flex flex-col justify-between cursor-pointer">
            <div>
          ...
          {/* 播客卡片 (已植入小宇宙真实链接) */}
          <a href="https://www.xiaoyuzhoufm.com/podcast/6537c168bc176817e8e2ac19" target="_blank" rel="noopener noreferrer" className="group p-8 rounded-3xl bg-white border border-gray-100 shadow-[0_2px_10px_rgba(0,0,0,0.02)] hover:shadow-[0_8px_30px_rgba(0,0,0,0.06)] hover:-translate-y-1 transition-all duration-500 flex flex-col justify-between cursor-pointer">
            <div>
          ...
          {/* 读书卡片 */}
          <div onClick={() => setActiveBeyond("reading")} className="group p-8 rounded-3xl bg-white border border-gray-100 shadow-[0_2px_10px_rgba(0,0,0,0.02)] hover:shadow-[0_8px_30px_rgba(0,0,0,0.06)] hover:-translate-y-1 transition-all duration-500 flex flex-col justify-between cursor-pointer">
            <div>
      ...
      {activeBeyond && (
        <div
          className="fixed inset-0 z-[100] flex items-center justify-center p-6 bg-white/60 backdrop-blur-2xl transition-all duration-500 animate-in fade-in"
              ...
              <div className="space-y-8">
                ...
                <div className="columns-2 md:columns-3 gap-4 [column-gap:1rem]">
                  {Array.from({ length: 20 }, (_, i) => {
                    ...
                    const aspect = portraitIds.includes(id) ? "2/3" : "3/2";
                    ...
                    <div key={`photo-${photo.id}`} className="mb-4 break-inside-avoid overflow-hidden rounded-2xl bg-gray-50">
                      <div className={`aspect-[${photo.aspect}] overflow-hidden rounded-2xl`}>
                        <img
                          src={photo.url}
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 pt-10 border-t border-white/10">
            ...
            <div className="flex flex-col">
              <span className="text-[10px] text-white uppercase tracking-[0.2em] mb-2 opacity-50">Email</span>
              <a href="mailto:1125183007@qq.com" className="text-sm font-light text-white hover:text-blue-400 transition-colors">
                1125183007@qq.com
              </a>
            </div>
